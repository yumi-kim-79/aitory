    ...
    <div className="flex flex-col flex-1 items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
          <button onClick={handleGoogle} disabled={googleLoading} type="button" className="w-full py-3 border border-slate-300 rounded-xl font-medium text-slate-700 hover:bg-slate-50 disabled:bg-slate-50 disabled:text-slate-400 transition-colors flex items-center justify-center gap-2 mb-4">
            {googleLoading ? (
              <><span className="inline-block w-5 h-5 border-2 border-slate-300 border-t-slate-600 rounded-full animate-spin" />로그인 중...</>
            ) : (
