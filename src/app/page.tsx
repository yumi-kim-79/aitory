...
const services = [
  ...
  { href: "/labor", icon: "📃", title: "AI 근로계약서", description: "근로조건에 맞는 표준 근로계약서를 자동 생성합니다", available: true, category: "문서작성" as Category },
  ...
  { href: "/trend", icon: "🔥", title: "실시간 트렌드 뉴스", description: "실시간 트렌드 키워드로 AI 요약 + SNS 콘텐츠를 자동 생성합니다", available: true, category: "마케팅" as Category },

  // 비즈니스
  { href: "/realestate", icon: "🏠", title: "부동산 공고문 생성", description: "조건 입력만으로 플랫폼별 공고문을 자동 생성합니다", available: true, category: "비즈니스" as Category },
  { href: "/realestate/check", icon: "🔍", title: "부동산 계약서 체크리스트", description: "부동산 계약서의 위험 요소를 AI가 체크합니다", available: true, category: "비즈니스" as Category },
  ...
  { href: "/petition", icon: "🏛️", title: "AI 민원서류 작성", description: "민원 내용을 입력하면 공공기관 제출용 서류를 작성합니다", available: true, category: "비즈니스" as Category },
];
