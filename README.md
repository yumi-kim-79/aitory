...
| 2026-04-09 | SEO+AEO 업데이트 + 색인 요청 타임아웃 수정 - 배치 처리(SEO 5개/색인 10개), UI 자동 반복+중단 버튼 |
| 2026-04-09 | SEO+AEO 배치 처리 버그 수정 - 401 토큰 만료(배치마다 forceRefresh), 진행률 분모 고정/분자 누적 |
...
| 2026-04-08 | 트윗 분리 - 1단계에서 트윗 제거(타임아웃 60초), post-to-x-bulk API + 3단계 수동 버튼 |
| 2026-04-08 | 3단계 트윗 타임아웃 수정 - Vercel after()로 fire-and-forget 백그라운드 실행 |
| 2026-04-08 | 3단계 트윗 직접 호출 방식으로 변경, after() 제거(Hobby 미지원), 클라이언트 290초 대기 |
| 2026-04-08 | 3단계 트윗 DALL-E 제거 - 텍스트만 트윗, 3초 간격, 30초 이내 완료 목표 |
...
| 2026-04-23 | Kbuzz 자동발행 K-POP 글로벌 최적화 - 100% 한류 콘텐츠, 영문 혼합 메타/태그 20개, 24시간 뉴스 필터, 2000자+ 풍부한 내용 |
| 2026-04-23 | Kbuzz 법적 안전장치 강화 - 실제 뉴스 기반 작성, 가상 정보 금지, 공식 출처 명시, 면책 조항 추가 |
